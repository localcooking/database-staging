...
------------+-----------------------------+-----------+----------+----------------------------------+----------+--------------+-------------
 ...
 inactive   | boolean                     |           | not null | false                            | plain    |              | 
Indexes:
...
Referenced by:
    TABLE "carts" CONSTRAINT "carts_item_id_fkey" FOREIGN KEY (item_id) REFERENCES menu_items(item_id) ON DELETE RESTRICT
    TABLE "menu_item_mapping" CONSTRAINT "menu_item_mapping_item_id_fkey" FOREIGN KEY (item_id) REFERENCES menu_items(item_id) ON DELETE RESTRICT
...
CREATE TABLE IF NOT EXISTS menu_items (
  ...
  deleted BOOLEAN NOT NULL DEFAULT FALSE -- pseudo-deletion of this data. FIXME what about revisions?
  /* TODO images */
...
Foreign-key constraints:
    "menu_item_mapping_item_id_fkey" FOREIGN KEY (item_id) REFERENCES menu_items(item_id) ON DELETE RESTRICT
...
Foreign-key constraints:
    "carts_item_id_fkey" FOREIGN KEY (item_id) REFERENCES menu_items(item_id) ON DELETE RESTRICT
...
CREATE TABLE IF NOT EXISTS carts (
  ...
  item_id INT NOT NULL REFERENCES menu_items (item_id) ON DELETE RESTRICT, /* menu_item_mapping is used only for views */
