...
CREATE TABLE IF NOT EXISTS users (
  ...
  password BYTEA NOT NULL CHECK (octet_length(password) == /* FIXME pkdf2 length */),
...
CREATE TABLE IF NOT EXISTS pending_registrations (
  ...
  auth_token BYTEA PRIMARY KEY CHECK (octet_length(auth_token) == /* FIXME sha512 length */)
);
...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  session_token BYTEA NOT NULL PRIMARY KEY CHECK (octet_length(session_token) == /* FIXME sha512 length */),
